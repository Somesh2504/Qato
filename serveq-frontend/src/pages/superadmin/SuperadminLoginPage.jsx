...
export default function SuperadminLoginPage() {
  ...
  const inputCls =
    'w-full h-12 rounded-xl bg-white/5 border border-white/10 px-4 text-sm text-white placeholder:text-white/30 focus:outline-none focus:border-[#FF6B35] focus:ring-2 focus:ring-[#FF6B35]/10 transition-all';
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#0f0f1a] p-4">
      ...
      <div className="relative w-full max-w-md bg-white/5 backdrop-blur border border-white/10 rounded-2xl shadow-2xl overflow-hidden">
        {/* Header */}
        <div className="p-6 border-b border-white/10 flex items-center gap-3">
          ...
          <div>
            <h1 className="text-lg font-bold text-white" style={{ fontFamily: "'Outfit','Inter',sans-serif" }}>
              QATO Superadmin
            </h1>
            <p className="text-xs text-white/40">Restricted Access</p>
          </div>
        </div>
